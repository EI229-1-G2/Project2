...
\textsc{\LARGE \bfseries 电子信息与电气工程学院}\\[1.5cm]

\textsc{\Large 工程实践与科技创新\uppercase\expandafter{\romannumeral4}-D}\\[0.5cm]


% Title
\HRule \\[0.5cm]
{ \huge \bfseries 加速度传感器信号采集与处理Lab2}\\[0.3cm]
...
\begin{center} \large
%\emph{Author:}\\
\textsc {\kaishu Group2\\郝常升，胡小雨，张洋榕\\高琛泰，李政}
\end{center}
\end{minipage}
%\begin{minipage}{0.4\textwidth}
